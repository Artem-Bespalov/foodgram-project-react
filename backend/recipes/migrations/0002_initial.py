# Generated by Django 3.2 on 2023-04-17 12:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ingredientinrecipe',
            name='recipe',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='recipes.recipe', validators=[django.core.validators.MinValueValidator(1, 'Должен быть хотябы 1 ингредиент')], verbose_name='Рецепт'),
        ),
        migrations.AddConstraint(
            model_name='ingredient',
            constraint=models.UniqueConstraint(fields=('name', 'measurement_unit'), name='Ингредиент должен быть уникален для рецепта'),
        ),
        migrations.AddField(
            model_name='favorite',
            name='recipe',
